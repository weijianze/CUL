...
class Config(object):
    def __init__(self):
        ...
        # test set
        # NDCrossSensor
        self._root_path_gallery = ['../../14CrossEyed/']
        self._gallery_list = ['../../14CrossEyed/gallery.txt']

        self._root_path_probe = ['../../14CrossEyed/']
        self._probe_list = ['../../14CrossEyed/probe.txt']

        self.data_name = 'CrossEyed'
