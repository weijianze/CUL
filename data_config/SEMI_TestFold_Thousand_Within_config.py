...
class Config(object):
    def __init__(self):
        self._root_path             = ['./']
        self._train_list_labeled    = ['./semi_protocol/Session_1/Train_1_9_labeled.txt']
        self._train_list_unlabeled  = ['./semi_protocol/Session_1/Train_1_9_unlabeled.txt']
        self._num_class             = 8102 # #classes for labeled training data
