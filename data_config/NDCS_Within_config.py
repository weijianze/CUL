...
class Config(object):
    def __init__(self):
        ...
        ####################### within dataset #########################
        # 03 NDCrossSensor     
        self._root_path.append('../../03NDCrossSensor/NormIm/')
        self._train_list.append('../../03NDCrossSensor/train.txt')
        ...
        # test set
        # NDCrossSensor
        self._root_path_gallery = ['../../03NDCrossSensor/NormIm/']
        self._gallery_list = ['../../03NDCrossSensor/LG2200_test_filtered.txt']

        self._root_path_probe = ['../../03NDCrossSensor/NormIm/']
        self._probe_list = ['../../03NDCrossSensor/LG4000_test_filtered.txt']
