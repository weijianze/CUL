...
class Config(object):
    def __init__(self):
        ...
        self._train_list.append('../../12UTIRIS/train.txt')
        self._num_class.append(79)
        self._normalize.append(dict(mean=0.2930,std=0.0843))
        # 13 PolyU_BMIRIS-1
        self._root_path.append('../../13PolyU_BMIRIS/')
        self._train_list.append('../../13PolyU_BMIRIS/Imglist_enhance.txt')
        ...
        # test set
        # NDCrossSensor
        self._root_path_gallery = ['../../12UTIRIS/']
        self._gallery_list = ['../../12UTIRIS/UTIRIS_NIR_test.txt']
        # self._gallery_list = ['../../12UTIRIS/NIR.txt']

        self._root_path_probe = ['../../12UTIRIS/']
        self._probe_list = ['../../12UTIRIS/UTIRIS_VIS_test.txt']
        # self._probe_list = ['../../12UTIRIS/VIS.txt']

        self.data_name = 'UTIRIS'
