...
def args_config():
    ...
    # -- save name
    # parser.add_argument('--experiment_name',  type=str,    default='Weakly_DisEmbedding') # checkpoint file name
    parser.add_argument('--experiment_name',  type=str,    default='Semi_TestFolds_1_9_Mixtrain') # checkpoint file name
    ...
    # -- loss
    parser.add_argument('--proj_strategy',  type=str,   default='none', choices=['linear', 'mlp', 'none'])         # [0: Linear   1: MLP   2: None]
